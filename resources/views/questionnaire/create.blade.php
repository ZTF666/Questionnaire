                ...
                <div class="card-body">
                   <form action="/questionnaires" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <small id="titleHelp" class="form-text text-muted">Give your questionnaire a fancy title.</small>
                      @error('title')
                      ...
                      <div class="form-group">
                        ...
                        <small id="purposeHelp" class="form-text text-muted">Giving purpose increases responses !</small>
                        @error('purpose')
                        <small class="text-danger">{{$message}}</small>
                        @enderror  
                    </div>
